...
<x-layout>
    ...
    <article class="py-8 max-w-screen-md border-b border-gray-300">
        ...
        <div class="text-base text-gray-500">
            ...
            <a class="hover:underline"href="/authors/{{ $post->user->username }}">{{ $post->user->name }}</a> in <a class="hover:underline"href="/categories/{{ $post->category->slug }}">{{ $post->category->name }}</a> | {{ $post->created_at->diffForHumans() }}
        </div>
